...
if (contactForm) {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        const payload = {
            access_key: 'f03f16f8-0c76-461c-93f0-6bd2204c05bf',
            name,
            email,
            message,
            subject: `Заявка с сайта FRIDRIX: ${name}`
        };
        ...
        try {
            ...
            if (data.success) {
                ...
                alert(data.message || 'Не удалось отправить. Попробуйте позже или напишите на hello@fridrix.design');
            }
        } catch (err) {
            alert('Ошибка сети. Попробуйте позже или напишите на hello@fridrix.design');
        } finally {
            if (submitBtn) {
